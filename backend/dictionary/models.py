...
class Employee(models.Model):
    ...
    additional_email = models.EmailField(verbose_name="Additional Email", blank=True, null=True)
    phone = models.CharField(max_length=20, verbose_name="Phone", blank=True, null=True)
    additional_phone = models.CharField(max_length=20, verbose_name="Additional Phone", blank=True, null=True)
    ...
    termination_date = models.DateField(verbose_name="Termination Date", blank=True, null=True)
    avatar = models.ImageField(upload_to='avatars/', verbose_name="Avatar", blank=True, null=True)
    registration_address = models.TextField(verbose_name="Registration Address", blank=True, null=True)
    living_address = models.TextField(verbose_name="Living Address", blank=True, null=True)

    class Meta:
        verbose_name = "Employee"
        verbose_name_plural = "Employees"
        permissions = [
            ("view_employees_list", "Can view employees list"),
            ("view_employee_details", "Can view employee details"),
            ("edit_employee_info", "Can edit employee information"),
        ]
